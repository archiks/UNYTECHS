        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="pointer-events-auto flex gap-4">
            {currentRoute === Route.ADMIN && (
              <button
                onClick={() => navigate(Route.HOME)}
                className="text-sm font-medium text-slate-400 hover:text-white flex items-center gap-2 transition-colors focus:outline-none"
              >
    ...
    <div className="min-h-screen flex items-center justify-center bg-brand-navy relative overflow-hidden">
      ...
      <div className="bg-brand-light p-10 rounded-3xl w-full max-w-md relative z-10 border border-white/10 shadow-2xl backdrop-blur-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase tracking-wider">Authentication Email</label>
            <input
              type="email"
              value={email}
          ...
          <div>
            <label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase tracking-wider">Access Key</label>
            <input
              type="password"
              value={password}
